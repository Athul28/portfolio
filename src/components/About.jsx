...
function About() {
  return (
    ...
    <div className="p-5">
        <img src={AboutPic} alt="AboutPic" className="m-auto w-[300px] rounded-2xl"/>
    </div>
    ...
    <p className="p-7 text-center text-slate-700">I am a student pursuing my Engineering at NMAMIT, and I am passionate about programming and learning new stuffs!</p>
    </div>
  );
}
